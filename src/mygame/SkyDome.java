...
public class SkyDome implements Control {
    ...
    public SkyDome(AssetManager assetManager, Camera cam, String model, String nightSkyMap, String moonMap, String cloudsMap, String fogAlphaMap) {
        ...
        tex_SkyNight = assetManager.loadTexture(nightSkyMap);
        tex_SkyNight.setMinFilter(MinFilter.BilinearNearestMipMap);
        tex_SkyNight.setMagFilter(MagFilter.Bilinear);
        tex_SkyNight.setWrap(WrapMode.Repeat);
        ...
        mat_Sky.setTexture("SkyNightMap", tex_SkyNight);
        if (moonMap != null) {
        ...
        sky = (Node) assetManager.loadModel(model);
        sky.setCullHint(Spatial.CullHint.Never);
        sky.setLocalScale(5f, 5f, 5f);
        sky.setMaterial(mat_Sky);
    }

    public void setSpatial(Spatial spatial) {
        this.spatial = spatial;
        ((Node) spatial).attachChild(sky);
    }
