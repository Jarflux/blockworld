...
public class Coordinate {
     ...
     */
    public static void findConnectedCorners(BlockContainer blockContainer, Coordinate start, boolean followGroundEdges, boolean followAirEdges, boolean followSurfaceEdges, int recursionDepth, Set<Coordinate> connectedCoordinates) {
        connectedCoordinates.add(start);
        if(recursionDepth <= 0) {
            return;
        }
        
        int block000 = blockContainer.getBlock(new Coordinate(start.x-1, start.y-1, start.z-1)) != null ? 1 : 0;
        int block001 = blockContainer.getBlock(new Coordinate(start.x-1, start.y-1, start.z)) != null ? 1 : 0;
        int block010 = blockContainer.getBlock(new Coordinate(start.x-1, start.y, start.z-1)) != null ? 1 : 0;
        int block011 = blockContainer.getBlock(new Coordinate(start.x-1, start.y, start.z)) != null ? 1 : 0;
        int block100 = blockContainer.getBlock(new Coordinate(start.x, start.y-1, start.z-1)) != null ? 1 : 0;
        int block101 = blockContainer.getBlock(new Coordinate(start.x, start.y-1, start.z)) != null ? 1 : 0;
        int block110 = blockContainer.getBlock(new Coordinate(start.x, start.y, start.z-1)) != null ? 1 : 0;
        int block111 = blockContainer.getBlock(new Coordinate(start.x, start.y, start.z)) != null ? 1 : 0;
        ...
        if((followSurfaceEdges && edgeXNeg > 0 && edgeXNeg < 4) || (followGroundEdges && edgeXNeg == 4) || (followAirEdges && edgeXNeg == 0)) {
            findConnectedCorners(blockContainer, new Coordinate(start.x-1,start.y,start.z), followGroundEdges, followAirEdges, followSurfaceEdges, recursionDepth-1, connectedCoordinates);
        }
        ...
        if((followSurfaceEdges && edgeYNeg > 0 && edgeYNeg < 4) || (followGroundEdges && edgeYNeg == 4) || (followAirEdges && edgeYNeg == 0)) {
            findConnectedCorners(blockContainer, new Coordinate(start.x,start.y-1,start.z), followGroundEdges, followAirEdges, followSurfaceEdges, recursionDepth-1, connectedCoordinates);
        }
        ...
        if((followSurfaceEdges && edgeZNeg > 0 && edgeZNeg < 4) || (followGroundEdges && edgeZNeg == 4) || (followAirEdges && edgeZNeg == 0)) {
            findConnectedCorners(blockContainer, new Coordinate(start.x,start.y,start.z-1), followGroundEdges, followAirEdges, followSurfaceEdges, recursionDepth-1, connectedCoordinates);
        }
